              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    NVC-Bot translates aggressive and passive-aggressive
            ...
            <div className="mx-auto grid max-w-5xl gap-8 mt-12">
              <div className="grid gap-8 md:grid-cols-3">
                ...
                <div className="flex flex-col items-center space-y-3 rounded-lg border p-6 shadow-sm">
                  ...
                  <p className="text-center text-gray-500 dark:text-gray-400">
                    Watch as messages are transformed into empathic
                    communication
                  </p>
                </div>
              </div>
        ...
        <section id="faq" className="py-16">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-3xl mt-12 space-y-4">
              ...
              <div className="rounded-lg border p-4">
                <h3 className="text-lg font-semibold">
                  Can NVC-Bot translate messages in languages other than
                  English?
                </h3>
                <p className="mt-2 text-gray-700 dark:text-gray-300">
      ...
      <footer className="border-t py-6 md:py-0 px-8">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <p className="text-center text-sm leading-loose text-gray-500 md:text-left">
            © 2025 NVC-Bot. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <Link
              href="#"
